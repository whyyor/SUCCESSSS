...
contract MetaBlackout is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    constructor(address _router, address _owner, address _burnWallet, address _developmentWallet, address _developmentWallet2, address payable _presale, address _presaleWallet) {
